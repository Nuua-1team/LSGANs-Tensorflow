...
if __name__ == '__main__':
    ...
    # optimize G
    G_train_op = tf.train.AdamOptimizer(learning_rate=0.05, beta1=0.5).minimize(errG, var_list=g_vars,
                                                                                 global_step=global_step)

    # optimize D
    D_train_op = tf.train.AdamOptimizer(learning_rate=0.05, beta1=0.5).minimize(errD, var_list=d_vars)
